...
if __name__ == '__main__':
    ...
    VAL_GT = f'/content/gdrive/My Drive/Arirang/data/train/{params["project_name"]}/annotations/instances_{SET_NAME}.json'
    VAL_IMGS = f'/content/gdrive/My Drive/Arirang/data/train/{params["project_name"]}/{SET_NAME}/'
    MAX_IMAGES = 10000
    coco_gt = COCO(VAL_GT)
